class ScreenMessages {
  ...
  showMainMenu(ctx, game) {
    ...
    ctx.fillText(
      "Players taking charges = BAD (HARD to sell a flop)",
      game.gameWidth / 2,
      670
    );
    ctx.fillText(
      "Players playing defence = GOOD (EASY to sell a flop)",
      game.gameWidth / 2,
      695
    );
    ctx.fillText(
      "Referees = BEST (they help you the most)",
      game.gameWidth / 2,
      720
    );
    ctx.fillText(
